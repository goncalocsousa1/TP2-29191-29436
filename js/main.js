...
const config = {
    ...
    scene: [MenuScene, MainScene, FirstLeftScene, SecondUpScene, ThirdUpScene, DialogueScene, DialogueSceneFL, HistoryScene, ControlsScene, LoseScene, FinishScene, BlueScreenScene],
    scale: {
        zoom:2,
    },
    physics: {
